...
# 使用Trivy扫描容器镜像
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock aquasec/trivy image monitoring-dashboard:latest
...
### CI/CD流水线
- 测试流水线: https://github.com/fabio2026-ui/monitoring-dashboard/actions/workflows/ci-cd-pipeline.yml
- 安全流水线: https://github.com/fabio2026-ui/monitoring-dashboard/actions/workflows/security-pipeline.yml
